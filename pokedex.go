...
func main() {
	...
	c.OnHTML("#monsters-list-wrapper > #monsters-list", func(e *colly.HTMLElement) {
		counter := 0
		const limit = 5
	...
	d.OnHTML("#mw-content-text > div.mw-parser-output > table.sortable.roundy.jquery-tablesorter > tbody", func(e *colly.HTMLElement) {
		counter := 0
		const limit = 5
		Pokemon := Pokemon{}
